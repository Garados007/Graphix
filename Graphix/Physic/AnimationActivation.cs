...
namespace Graphix.Physic
{
    ...
    /// <summary>
    /// An activator that activates if the channel was changed
    /// </summary>
    public class ChannelActivation : AnimationActivation
    {
        /// <summary>
        /// The old channel name
        /// </summary>
        public ValueWrapper<string> Old { get; set; }
